...
export class UserService {
  ...
  async all(): Promise<UserEntity[]> {
    ...
    return await this.userRepository.find({select:['id','first_name','last_name','gender','birthDate','attributionDate','rue','commune','ville','actif','gsm','email','status','level'],relations:['level']});
  }
